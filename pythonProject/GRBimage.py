...
# Parameters
########################################################################################################################
img_path = 'D:\crown_rot_image\colour'
# img_name = 'whole.jpg'
img_name = 'whole0203.jpg'
...
ax_f1[0].imshow(rgb_uint8, cmap='jet')
...
ax_f2[0, 0].imshow(rgb, cmap='jet')
ax_f2[0, 0].set_title('RGB image')

ax_f2[0, 1].imshow(red, cmap='jet')
...
########################################################################################################################
# saturation and green
########################################################################################################################
bw1 = np.logical_and(green < t_green
                    , saturation > t_saturation)

f5, ax_f5 = plt.subplots()
ax_f5.imshow(bw1, cmap='gray')
plt.pause(0.01)
